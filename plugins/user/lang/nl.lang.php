...
$_['Email not found'] = '';
$_['You have to give your username or email'] = '';
$_['Resetting your password failed'] = '';
$_['%site: Your account information'] = '';
$_['A mail has been sent to you. Please follow the directions to set a new password for your account.'] = '';
$_['%site: Your new password'] = '';
$_['Invalid key'] = '';
$_['Welcome %u!'] = '';
$_['Forgot your password?'] = '';
$_['Hi %username'] = '';
$_['We have created (on your request) a new password for your account on "%site"'] = '';
$_['Username: %username'] = '';
$_['Password: %password'] = '';
$_['You can login at %loginURL'] = '';
$_['Someone (possibly you) has requested a new password for your account "%user" on %site.'] = '';
$_['If you do not want this action to be taken, simply ignore this message and the request will be disregarded (your password will remain unchanged).'] = '';
$_['Password reset'] = '';
$_['Reset password'] = '';
?>